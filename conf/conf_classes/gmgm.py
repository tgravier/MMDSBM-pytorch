...
class ExperimentConfig:
    def __init__(self):
        ...
        self.experiment_name = "gmgm_ver03ode_04"
        ...
        self.warmup = True
        self.warmup_nb_inner_opt_steps = 30000
        self.warmup_epoch = 0
        # ───── Optimization
        self.lr = 1e-4
        self.grad_clip = 10
...
class DistributionConfig:
    def __init__(self, dim: int = 2, n_samples: int = 10000):
        ...
        self.distributions = [
            ...
            GaussianConfig(time=2,mean=[0,0],std = [1,1], n_samples = 10000,dim=2),
            MoonConfig(time=3,n_samples=10000,noise = 0.2),
