...
class ExperimentConfig:
    def __init__(self):
        ...
        self.experiment_name = "gaussian_50d_07"
        ...
        self.log_wandb_params = True
        self.param_metric = True
...
class DistributionConfig:
    def __init__(self, dim: int = 2, n_samples: int = 10000):
        ...
        self.distributions = [
                                    ...
                                    GaussianConfig(time=0, mean=[-0.1] * 50, std=[1.0] * 50, n_samples=10000, dim=50),
                                    GaussianConfig(time=1, mean=[0.1] * 50,  std=[1.0] * 50, n_samples=10000, dim=50),
                                    GaussianConfig(time=2, mean=[-0.1] * 50, std=[1.0] * 50, n_samples=10000, dim=50),
                                    GaussianConfig(time=3, mean=[0.1] * 50,  std=[1.0] * 50, n_samples=10000, dim=50),
                                ]
