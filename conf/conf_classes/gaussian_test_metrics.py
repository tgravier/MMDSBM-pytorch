...
class ExperimentConfig:
    def __init__(self):
        ...
        self.experiment_name = "test_metrics_01"
...
class DistributionConfig:
    def __init__(self, dim: int = 2, n_samples: int = 10000):
        ...
        self.distributions = [
            ...
            GaussianConfig(time=0,mean=[-0.1,-0.1],std = [1,1], n_samples = 10000,dim=2),
            GaussianConfig(time=2,mean=[0.1,0.1],std = [1,1], n_samples = 10000,dim=2),
            GaussianConfig(time = 3, mean = [0,0], std = [1,1], n_samples= 10000, dim =2)
